            ...
            <div class="overflow-hidden sm:rounded-lg">
                ...
                <div class="container mx-auto mt-8 bg-white shadow-md">
                    <div class="flex items-end justify-between px-4 py-3 text-white bg-gray-700 rounded-t">
                        <h2 class="pb-1 font-semibold">Add Tool</h2>
                        <a href="{{ route('backend.tools.index') }}" class="px-2 py-1 text-sm text-white bg-blue-500 rounded hover:bg-blue-200 hover:text-blue-800">Back to all users</a>
                    </div>

                    <form method="POST" action="{{ route('backend.tools.store') }}" class="w-full max-w-2xl p-4">
                        @csrf
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <textarea rows="7" class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-100 border-2 border-gray-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-200" id="inline-short-desc" name="short_desc"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="w-5 h-5 text-green-600 rounded" id="inline-is_enabled" type="checkbox" value="1" name="is_enabled">
                            </div>
                        </div>
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="w-5 h-5 text-green-600 rounded" id="inline-is_locked" type="checkbox" value="1" name="is_locked">
                            </div>
                        </div>
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-100 border-2 border-gray-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-200" id="inline-owner" type="text" value="" name="owner">
                            </div>
                        </div>
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-100 border-2 border-gray-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-200" id="inline-sort-number" type="number" value="" name="sort_number">
                            </div>
                        </div>
                        ...
                        <div class="mb-6 md:flex md:items-center">
                            ...
                            <div class="md:w-2/3">
                                <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-100 border-2 border-gray-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-200" id="inline-primary-api-endpoint" type="text" value="" name="primary_api_endpoint">
                            </div>
                        </div>
